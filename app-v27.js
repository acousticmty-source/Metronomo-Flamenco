...
const palos = {
  ...
  alegrias: {
    ...
    accents: ["12", "3", "6", "8", "10"],
    ornaments: [
      { beat: "1", offsetBeats: 0.42, volume: 0.26 },
      { beat: "1", offsetBeats: 0.64, volume: 0.22 },
      { beat: "4", offsetBeats: 0.42, volume: 0.26 },
      { beat: "4", offsetBeats: 0.64, volume: 0.22 },
      { beat: "7", offsetBeats: 0.42, volume: 0.3 },
      { beat: "7", offsetBeats: 0.64, volume: 0.24 },
      { beat: "9", offsetBeats: 0.42, volume: 0.28 },
      { beat: "9", offsetBeats: 0.64, volume: 0.23 },
    ],
  },
  soleaPorBuleria: {
