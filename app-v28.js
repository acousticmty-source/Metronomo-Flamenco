...
const palos = {
  ...
  alegrias: {
    ...
    pulseVolume: 0.34,
    ornaments: [
      { beat: "12", offsetBeats: 0.46, volume: 0.52 },
      { beat: "12", offsetBeats: 0.72, volume: 0.42 },
      { beat: "3", offsetBeats: 0.46, volume: 0.5 },
      { beat: "3", offsetBeats: 0.72, volume: 0.4 },
      { beat: "6", offsetBeats: 0.46, volume: 0.52 },
      { beat: "6", offsetBeats: 0.72, volume: 0.42 },
      { beat: "8", offsetBeats: 0.46, volume: 0.5 },
      { beat: "8", offsetBeats: 0.72, volume: 0.4 },
      { beat: "10", offsetBeats: 0.62, volume: 0.42 },
    ],
  },
  soleaPorBuleria: {
    ...
    ornaments: [
      { beat: "2", offsetBeats: 0.72, volume: 0.16 },
      { beat: "5", offsetBeats: 0.72, volume: 0.16 },
      { beat: "9", offsetBeats: 0.72, volume: 0.14 },
    ],
  },
  seguiriyas: {
    label: "Seguiriyas",
